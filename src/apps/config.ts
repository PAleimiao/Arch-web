...
export const APPS: AppConfig[] = [
  ...
  // ===== 游戏 =====
  { id: 'steam', name: 'Steam', icon: 'Gamepad2', category: '游戏', description: '游戏平台', defaultWidth: 950, defaultHeight: 620, component: 'Steam', color: '#1B2838' },
  { id: 'minecraft', name: 'Minecraft', icon: 'Box', category: '游戏', description: '沙盒游戏', defaultWidth: 850, defaultHeight: 600, component: 'Minecraft', color: '#5D8C38' },
